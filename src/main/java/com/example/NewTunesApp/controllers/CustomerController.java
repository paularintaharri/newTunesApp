...
public class CustomerController {
    ...
    @RequestMapping(value="/api/v1/customers/country/total", method = RequestMethod.GET)
    ...
    @RequestMapping(value="/api/v1/customers/max/spender", method = RequestMethod.GET)
    ...
    @RequestMapping(value="/api/v1/customers/{CustomerId}/popular/genre", method = RequestMethod.GET)
